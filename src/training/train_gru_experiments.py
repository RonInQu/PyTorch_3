...
def extract_features_exp(cfg, exp_name):
    ...
    cache_name = f"features_exp{exp_name}_w{window_sec:.1f}s_s{STRIDE_SAMPLES}_seq{seq_len}_{FEATURE_SET}.npz"
...
def main():
    ...
    X_seq, y, groups = extract_features_exp(cfg, args.exp)
