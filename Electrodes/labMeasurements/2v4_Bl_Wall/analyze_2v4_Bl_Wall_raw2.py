...
# Base color per tissue / blood group
GROUP_COLORS = {
    "Blood": "#1f77b4",
    "TA": "#2ca02c",
    "TB": "#ff7f0e",
...
# Distinct style for 2-electrode vs 4-electrode
# 2-electrode: solid, darker/full color
# 4-electrode: dashed, lighter shade
ELEC_STYLE = {
    2: {"linestyle": "-",  "linewidth": 2.4, "alpha": 1.0},
    4: {"linestyle": "--", "linewidth": 2.2, "alpha": 0.85},
}

# Explicit per-sample colors so 2 and 4 are always different
SAMPLE_COLORS = {
    "B2":  "#1f77b4",
    "B4":  "#aec7e8",
    "TA2": "#2ca02c",
...
def plot_group(
    ...
    for label, df in sorted(dfs.items()):
        ...
        ax1.plot(
            df["frequency_khz"], df["impedance_ohm"],
