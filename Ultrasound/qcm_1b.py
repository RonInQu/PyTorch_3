...
def run_single_frequency_case(f_nominal: float):
    ...
    out_path = output_dir / f"qcm_response_{f_mhz_int}MHz_no_air.png"
...
for f_nominal in nominal_frequencies:
    ...
    print("=" * 82)
    print(f"Nominal Crystal: {f_nominal/1e6:.0f} MHz  (Air omitted)")
