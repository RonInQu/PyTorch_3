...
def evaluate_study(
    ...
    min_duration_samples: int = None, multichannel: bool = True,
) -> dict:
...
def plot_overlay(
    ...
    output_dir: Path, min_duration_samples: int = None,
...
def main():
    ...
    parser.add_argument("--min_duration", type=float, default=cfg.MIN_EVENT_DURATION_SEC)
