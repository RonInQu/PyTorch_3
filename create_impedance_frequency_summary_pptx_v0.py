...
# ═══════════════════════════════════════════════════════════════════════
# SLIDE 6b — 3-frequency feature comparison
# ═══════════════════════════════════════════════════════════════════════
s = prs.slides.add_slide(prs.slide_layouts[6])
...
# ═══════════════════════════════════════════════════════════════════════
# SLIDE 8 — What COMSOL 3D adds (capability/impact table)
# ═══════════════════════════════════════════════════════════════════════
s = prs.slides.add_slide(prs.slide_layouts[6])
...
add_table(s, 0.5, 1.2, 12.3, 5.0,
          ...
          hdr_color=DARK_GREEN, font_sz=11)


# ═══════════════════════════════════════════════════════════════════════
# SLIDE 9 — 10 Reasons for COMSOL
# ═══════════════════════════════════════════════════════════════════════
s = prs.slides.add_slide(prs.slide_layouts[6])
...
# ═══════════════════════════════════════════════════════════════════════
# SLIDE 10 — Without vs With COMSOL comparison
# ═══════════════════════════════════════════════════════════════════════
s = prs.slides.add_slide(prs.slide_layouts[6])
...
# ═══════════════════════════════════════════════════════════════════════
# SLIDE 11 — E-Field Penetration Depth
# ═══════════════════════════════════════════════════════════════════════
s = prs.slides.add_slide(prs.slide_layouts[6])
...
# ═══════════════════════════════════════════════════════════════════════
# SLIDE 12 — Joule Heating / Power Density
# ═══════════════════════════════════════════════════════════════════════
s = prs.slides.add_slide(prs.slide_layouts[6])
...
# ═══════════════════════════════════════════════════════════════════════
# SLIDE 13 — Sensing Depth (cumulative energy)
# ═══════════════════════════════════════════════════════════════════════
s = prs.slides.add_slide(prs.slide_layouts[6])
